        ...
        <div class="row-1">
            ...
            <div class="container" >
                <div id="block404Left" class="span5">
                    <p class="error404">Forbidden</p>
                    <p style="font-size: 17px">This page is forbidden if you are not a member of this project</p>
                </div>
                <div id="block404Right" class="span5">
                    <p class="textLink404">Come back to the home : </p>
                    <p><a class="link404 linkBlack" href="/">QManager</a></p>
                </div>
            </div>
        </div>
    </div>
