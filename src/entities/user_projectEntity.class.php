	...
	<?php
		...
		class user_projectEntity {
			...
			public function Update(){
				...
				$sql = 'UPDATE `user_project` SET `user_id` = "'.$this->user_id.'", `project_id` = "'.$this->project_id.'", `rights_key` = "'.$this->rights_key.'" WHERE rights_key = '.intval($this->rights_key);
			...
			public function Insert(){
				...
				$sql = 'INSERT INTO user_project (`user_id`,`project_id`,`rights_key`) VALUES ("'.$this->user_id.'","'.$this->project_id.'","'.$this->rights_key.'")';
