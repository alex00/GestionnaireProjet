	...
	<?php
		...
		class usersEntity {
			...
			public function Update(){
				...
				$sql = 'UPDATE `users` SET `id` = "'.$this->id.'", `user_mail` = "'.$this->user_mail.'", `password` = "'.$this->password.'", `user_img_url` = "'.$this->user_img_url.'", `user_login` = "'.$this->user_login.'", `user_login_code` = "'.$this->user_login_code.'", `user_date_create` = "'.$this->user_date_create.'" WHERE id = '.intval($this->id);
			...
			public function Insert(){
				...
				$sql = 'INSERT INTO users (`id`,`user_mail`,`password`,`user_img_url`,`user_login`,`user_login_code`,`user_date_create`) VALUES ("'.$this->id.'","'.$this->user_mail.'","'.$this->password.'","'.$this->user_img_url.'","'.$this->user_login.'","'.$this->user_login_code.'","'.$this->user_date_create.'")';
