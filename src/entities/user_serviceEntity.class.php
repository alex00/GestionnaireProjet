<?php
    ...
    public function countMembersProject($user_id){

        $sql = 'SELECT COUNT(`project_id`) AS nb_members FROM user_service WHERE user_id ='.$user_id;
...
WHERE project_code = "'.$project_code.'"';
    ...
    public function findCreatedProjects($project_id){
        ...
        $sql = 'SELECT user_login FROM user_service LEFT JOIN users ON user_service.`user_id` = users.`id` WHERE project_id ='.$project_id.' AND rightKey =1';
    ...
    public function listProjectAffiliated($user_id){
        $sql =  'SELECT * FROM projects LEFT JOIN user_service ON user_service.project_id = projects.project_id WHERE user_service.user_id = :user_id AND user_service.rightKey <>1';
